function [predict_label,score_s,numK,P] = tsk(X_train,Y_train,X_test)
...
options.lambda=0.5;
options.h=5;
iters=1000;flag1=[3 0.5];flag2=0;flag3=0;
...
[P,numK] = sparse_learning(G_train,Y_train,options.lambda,iters,flag1,flag2,flag3);
