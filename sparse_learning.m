function [mu,k] = sparse_learning(Phi,T,lambda,iters,flag1,flag2,flag3)
% *************************************************************************
% [mu,dmu,k,gamma] = sparse_learning(Phi,T,lambda,iters,flag1,flag2,flag3)
% *** PURPOSE *** 
% Implements generalized versions of BSBL and FOCUSS for learning sparse
